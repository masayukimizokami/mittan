...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { family_name: @family.family_name, family_pr: @family.family_pr, image: @family.image } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { family_name: @family.family_name, family_pr: @family.family_pr, image: @family.image } }
