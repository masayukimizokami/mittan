...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { comment: @score.comment, family_id: @score.family_id, score: @score.score } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { comment: @score.comment, family_id: @score.family_id, score: @score.score } }
