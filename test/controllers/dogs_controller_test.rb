...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { image: @dog.image, kigen: @dog.kigen, name: @dog.name, onaka: @dog.onaka, pr: @dog.pr, yobip: @dog.yobip } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { image: @dog.image, kigen: @dog.kigen, name: @dog.name, onaka: @dog.onaka, pr: @dog.pr, yobip: @dog.yobip } }
