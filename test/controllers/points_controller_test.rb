...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { comment: @point.comment, family_id: @point.family_id, score: @point.score } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { comment: @point.comment, family_id: @point.family_id, score: @point.score } }
